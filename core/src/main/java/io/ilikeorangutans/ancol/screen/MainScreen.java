...
public class MainScreen implements Screen {
	...
	public MainScreen(final Game game, final Skin skin, final InputProcessorFactory inputProcessorFactory, final TextureAtlas atlas) {
		...
		startGame.addListener(new ClickListener() {
			@Override
			public void clicked(InputEvent event, float x, float y) {
				game.setScreen(new GameScreen(skin, inputProcessorFactory, atlas));
			}
		});
